...
export default function TodijoUmbrellaMark({ className = "", animated = false }: Props) {
  return <svg className={`${className}${animated ? " isAnimated" : ""}`} viewBox="0 0 240 240" role="img" aria-label="Todijo">
    <defs>
      ...
      <linearGradient id="todijo-to" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#7c3aed"/><stop offset="1" stopColor="#4c1d95"/></linearGradient>
      <linearGradient id="todijo-di" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#a855f7"/><stop offset="1" stopColor="#6d28d9"/></linearGradient>
      <linearGradient id="todijo-jo" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#5b21b6"/><stop offset="1" stopColor="#d946ef"/></linearGradient>
    ...
    <g className="umbrellaCanopy" filter="url(#todijo-shadow)">
      ...
      <circle cx="120" cy="39" r="7" fill="#b967ff" stroke="#fff" strokeWidth="2"/>
