...
export default function MarketplaceLegalPolicy({ title, intro, statusNote, traderNote, sections, supportEmail, relatedLinks=[] }: { title: string; intro: string; statusNote: string; traderNote?: string; sections: LegalSection[]; supportEmail: string; relatedLinks?:Array<{label:string;href:string}> }) {
