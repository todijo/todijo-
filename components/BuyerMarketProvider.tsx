...
export default function BuyerMarketProvider({children}:{children:React.ReactNode}){
 ...
 const previewCountry=process.env.NODE_ENV==="production"?undefined:locale==="fr"?"FR":undefined;
 const [market,setMarket]=useState<BuyerMarket>(()=>resolveBuyerMarket({detectedCountry:previewCountry})),[ready,setReady]=useState(false),[scope,setScope]=useState(BUYER_MARKET_GUEST_SCOPE);
