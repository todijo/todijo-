...
test("pricing, cart and country continue to use canonical selection identity", () => {
  ...
  assert.match(pricing, /variantId,quantity,destinationCountry:country/); assert.match(pricing, /api\/account\/addresses/); assert.doesNotMatch(pricing,/account\/addresses`|addShippingAddress|changeAddress/);
