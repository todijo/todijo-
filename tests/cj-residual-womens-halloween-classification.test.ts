...
const sample: SupplierProductSnapshot = {provider:"CJ",supplierProductId:"2410190940451618400",sku:null,title:"Underwear Halloween Clothing Suit Women",description:"",categoryReference:null,sourceUrl:null,cost:null,currency:"USD",stock:0,available:true,weightGrams:null,variants:[],media:[],rawMetadata:{}};
