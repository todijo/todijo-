...
test("professional identity is retained while private identity fields are cleared", () => {
  assert.deepEqual(sellerIdentityInput({ legalBusinessName: " Example SARL ", businessRegistrationId: "ABC-1", vatNumber: "FR123" }, "PROFESSIONAL"), {
    legalBusinessName: "Example SARL", businessRegistrationId: "ABC-1", businessAddress: null, businessPostalCode: null, vatNumber: "FR123",
  });
  assert.deepEqual(sellerIdentityInput({ legalBusinessName: "Must not remain", vatNumber: "FR123" }, "PRIVATE"), {
    legalBusinessName: null, businessRegistrationId: null, businessAddress: null, businessPostalCode: null, vatNumber: null,
  });
