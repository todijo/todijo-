...
const provider={getVariant:async()=>({supplierProductId:"CJ-PID",supplierVariantId:"CJ-VID",sku:null,title:"Purple XL",cost:8,currency:"USD",stock:5,available:true,originCountryCodes:["CN"]}),calculateFreight:async()=>({selected:{id:"yun",name:"YunExpress",amount:"4",currency:"USD" as const,estimatedDelivery:"8-15 days",originCountry:"CN",destinationCountry:"FR"},methods:[],variantId:"CJ-VID",quantity:1,calculatedAt:new Date().toISOString(),cached:false})};
