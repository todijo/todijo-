  ...
  return (
    <form className="storeForm productForm" onSubmit={submit}>
      ...
      <div className="formRow">
        ...
        <div className="formField">
          <label htmlFor="compareAtPrice">Ancien prix / prix avant remise ({currency})</label>
          <input id="compareAtPrice" name="compareAtPrice" type="number" min="0.01" max="1000000" step="0.01" placeholder="39.99 (facultatif)" />
        </div>
      </div>
