...
import ShippingRuleFields, { shippingDraftPayload, type ShippingDraft } from "@/components/ShippingRuleFields";
  ...
  return (
    <form className="storeForm storeSettingsForm" onSubmit={submit}>
      ...
      <SellerSection id="shipping" icon={Truck} title={shipping("settingsTitle")} description={shipping("settingsHelp")}>
        <ShippingRuleFields value={shippingRule} onChange={setShippingRule} currency={initialValues.currency}/>
      </SellerSection>
