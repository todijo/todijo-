        ...
        {!user.store ? (
          ...
          <>
            ...
            <section className="dashboardQuickActions">
              ...
              <div>
                <button type="button" disabled>＋ Ajouter un produit</button>
                <button type="button" disabled>📦 Gérer les produits</button>
                <button type="button" disabled>⚙️ Paramètres de la boutique</button>
              </div>
              <p>La gestion des produits arrive dans la prochaine étape.</p>
            </section>
          </>
        )}
      </div>
