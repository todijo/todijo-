...
export default async function AdminSuppliersPage() {
  ...
  const store = await prisma.store.findUnique({
    ...
    select: { products: { where: { supplierLink: { is: { ownerType: "PLATFORM", connectionId: PLATFORM_CJ_CONNECTION_ID } } }, orderBy: { createdAt: "desc" }, select: { id: true, name: true, price: true, currency: true, supplierLink: { select: { provider: true, supplierCost: true, supplierCurrency: true, supplierStock: true, syncStatus: true, lastSyncedAt: true } } } } },
  });
