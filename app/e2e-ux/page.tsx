...
export default async function UxVerificationPage({ searchParams }: { searchParams: Promise<{ view?: string }> }) {
  ...
  return <HomeClient products={products} heroProducts={products} newArrivals={[]} bestSellers={[]} stores={[]} categories={["electronics"]} total={2} page={1} pageSize={24} initialFilters={{ q: "", category: "", minPrice: "", maxPrice: "", condition: "", country: "", rating: "", availability: "", sort: "newest" }} resultsOnly={view !== "home"}/>;
}
