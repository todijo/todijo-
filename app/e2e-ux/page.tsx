...
export default async function UxVerificationPage({ searchParams }: { searchParams: Promise<{ view?: string }> }) {
  ...
  return <HomeClient products={products} newArrivals={[]} bestSellers={[]} stores={[]} categories={["electronics"]} total={2} page={1} pageSize={24} initialFilters={{ q: "", category: "", minPrice: "", maxPrice: "", condition: "", city: "", country: "", availability: "", sort: "newest" }} resultsOnly/>;
}
