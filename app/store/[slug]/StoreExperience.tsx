...
type Props = { store: { name:string; slug:string; description:string|null; logo:string|null; banner:string|null; country:string; city:string; openedLabel:string; sellerName:string; sellerInitials:string; sellerSince:string; emailConfirmed:boolean; sellerType:"UNKNOWN"|"PROFESSIONAL"|"PRIVATE"; professionalInfo:{legalBusinessName:string|null;businessRegistrationId:string|null;businessAddress:string|null;businessPostalCode:string|null;vatNumber:string|null}|null; productCount:number; page:number; pages:number; products:Product[] } };
